...
def init_plot():
    ...
    slist.append(Indicator(master=root, label='Memory', value=10, f = 0, t = 100))
    slist.append(Indicator(master=root, label='Alpha %', value=1, f = 0, t = 100))
...
def regcb():
    ...
    if regCounter % 200 == 0:
        ...
        if others != 0 and highest/(others*1.0) >= .95:
            print j, alpha, i,  "1"
        else:
            print j, alpha, i,  "0"     
